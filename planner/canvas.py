...
<div class="canvas-shell">
  ...
  <div class="canvas-tools">
    ...
    <button type="button" data-tool="fullscreen" class="fullscreen-toggle" aria-pressed="false">도면 전체보기</button>
...
planner_canvas = st.components.v2.component("floorplan_furniture_canvas_v10_1", html=HTML, css=CSS, js=JS)
